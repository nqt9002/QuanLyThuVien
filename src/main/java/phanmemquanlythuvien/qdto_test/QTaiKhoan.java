...
public class QTaiKhoan extends com.querydsl.sql.RelationalPathBase<TaiKhoan> {
    ...
    private static final long serialVersionUID = -1240683763;
    ...
    public final com.querydsl.sql.PrimaryKey<TaiKhoan> _TaiKhoan_AD7C65292E73D9E2PK = createPrimaryKey(maTaiKhoan);
