...
public class QBanDoc extends com.querydsl.sql.RelationalPathBase<QBanDoc> {
    ...
    public final com.querydsl.sql.PrimaryKey<QBanDoc> _BanDoc_272475A72360E787PK = createPrimaryKey(maBD);

    public final com.querydsl.sql.ForeignKey<QMuonTra> __MuonTra_MaBD_3A81B327FK = createInvForeignKey(maBD, "MaBD");
