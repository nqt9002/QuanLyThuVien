...
public class QDauSach extends com.querydsl.sql.RelationalPathBase<DauSach> {
    ...
    private static final long serialVersionUID = -2108315907;
    ...
    public final com.querydsl.sql.PrimaryKey<DauSach> _DauSach_2725865431CBE2EFPK = createPrimaryKey(maDS);

    public final com.querydsl.sql.ForeignKey<ChuDe> _DauSach_MaCD_2F10007BFK = createForeignKey(maCD, "MaCD");

    public final com.querydsl.sql.ForeignKey<Nxb> _DauSach_MaNXB_2E1BDC42FK = createForeignKey(maNXB, "MaNXB");

    public final com.querydsl.sql.ForeignKey<TacGia> _DauSach_MaTG_2D27B809FK = createForeignKey(maTG, "MaTG");

    public final com.querydsl.sql.ForeignKey<Sach> __Sach_MaDS_32E0915FFK = createInvForeignKey(maDS, "MaDS");
    ...
    public void addMetadata() {
        addMetadata(lanTaiBan, ColumnMetadata.named("LanTaiBan").withIndex(8).ofType(Types.INTEGER).withSize(10).notNull());
        ...
        addMetadata(soLuong, ColumnMetadata.named("SoLuong").withIndex(7).ofType(Types.INTEGER).withSize(10).notNull());
        addMetadata(ten, ColumnMetadata.named("Ten").withIndex(6).ofType(Types.NVARCHAR).withSize(60).notNull());
        addMetadata(ttnd, ColumnMetadata.named("TTND").withIndex(5).ofType(Types.NVARCHAR).withSize(1000).notNull());
