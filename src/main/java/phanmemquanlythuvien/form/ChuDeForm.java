 ...
 * @author tainguyen
 */
public class ChuDeForm extends javax.swing.JFrame {

 //   private static Logger logger = Logger.getLogger(ChuDeForm.class);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChuDeForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChuDeForm(new ChuDe()).setVisible(true);
            }
        });
    }
